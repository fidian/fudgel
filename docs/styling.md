...
<code-sample sample="samples/basic-styling.json"></code-sample>
...
<code-sample sample="samples/avoid-style-scoping.json"></code-sample>

## Light DOM

<code-sample sample="samples/styling-example-light-dom.json"></code-sample>
...
<code-sample sample="samples/styling-example-light-dom-generated.json"></code-sample>

## Shadow DOM

Things are slightly different for Shadow DOM. This next example simply changes `useShadow: true` to leverage Shadow DOM.

<code-sample sample="samples/styling-example-shadow-dom.json"></code-sample>
...
<code-sample sample="samples/styling-example-shadow-dom-generated.json"></code-sample>
