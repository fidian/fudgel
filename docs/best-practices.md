...
<code-sample sample="samples/assign-only-once.json"></code-sample>
...
<code-sample sample="samples/export-component-function.json"></code-sample>
...
<code-sample sample="samples/data-flow-into-component.json"></code-sample>
...
<code-sample sample="samples/emit-and-exposing-property.json"></code-sample>

Alternately, you can use a service to share data between components. This example uses the built-in `Emitter` class.

<code-sample sample="samples/service-data-sharing.json"></code-sample>
